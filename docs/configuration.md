...
## OffLine-установка
Обычная установка XKeen и необходимых компонентов выполняется в OnLine режиме и жёстко привязана к GitHub, а в случае его недоступности будет невозможна. Поэтому в форк дополнительно к способу установки через [Self-Hosted](#self-hosted-прокси-для-загрузки-компонентов)-прокси добавлен режим OffLine-установки по команде `xkeen -io`
